...
<body>
    ...
    <div class="container">
        ...
        <div id="inbox-section">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                % elif c.get('statut') == 'distribué':
                                    <span style="color: orange;">Distribué</span>
                                % else:
                                    <span style="color: red;">Non défini</span>
                                % end
                            </td>
                            <td>
                                % if c.get('statut') == 'non lu':
                                    <a href="/statut/lu/{{c['id']}}" class="btn btn-danger btn-sm">
                                        Marquer comme lu
                                    </a>
                                % elif c.get('statut') == 'lu':
                                    <a href="/statut/distribué/{{c['id']}}" class="btn btn-success btn-sm">
                                ...
                                % else:
                                    <a href="/statut/non%20lu/{{c['id']}}" class="btn btn-secondary btn-sm">
                                        Statut inconnu
                                    </a>
                                % end

                                <a href="/edit/{{c['id']}}" class="btn btn-warning btn-sm">Éditer</a>
                                <a href="/delete/{{c['id']}}" class="btn btn-danger btn-sm" onclick="return confirm('Voulez-vous vraiment supprimer ce courrier ?');">Supprimer</a>
                            </td>
                        </tr>
                        % end
                    </tbody>
            ...
            % else:
                <div class="no-mails">Aucun courrier reçu.</div>
            % end
        </div>
    </div>
